...
use App\Imports\RecomendadorImport;
...
class RecomendadorController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('data.recomendador.index', compact('data','request','fields'));
    }
    ...
    {
        return view('data.recomendador.create');
    }
    ...
    {
        return Excel::download(new DataExport('recomendador','recomendador'), 'recomendador.xlsx');
    } 
    ...
    public function import(Request $request)
    {
        ...
        if ($request->get('mode') == 'deleteAndAdd') {
            DB::table('data')->where('reporte', '=','recomendador')->delete();
        }
        
        Excel::import(new RecomendadorImport, $request->file('import-file'));
        activity()->log('importo datos de recomendador');
        Session::flash('alert-success','Datos importados con exito');        
        return Redirect::route('data.recomendador.index');        
    }
