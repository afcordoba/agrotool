@extends('layouts.app')
@section('title', 'Importar Fecha de Siembra')
@section('content-header')
    @component('components.content-header', ['breadcrumb' => ['Fecha de Siembra' => route('data.fecha.index')]])
        @slot('title')
            Importar Fecha de Siembra
        @endslot
    @endcomponent
@endsection
@section('css')
...
<div class="box box-primary">
    <form class="form-horizontal" action="{{ route('data.fecha.import')}}" method="POST" enctype="multipart/form-data"> 
        <div class='box-body'>  
            @csrf
