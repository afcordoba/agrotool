@extends('layouts.app')
@section('title', 'Importar Recomendador de Variedades')
@section('content-header')
    @component('components.content-header', ['breadcrumb' => ['Recomendador de Variedades' => route('data.recomendador.index')]])
        @slot('title')
            Importar Recomendador de Variedades
        @endslot
    @endcomponent
@endsection
@section('css')
...
<div class="box box-primary">
    <form class="form-horizontal" action="{{ route('data.recomendador.import')}}" method="POST" enctype="multipart/form-data"> 
        <div class='box-body'>  
            @csrf
