@extends('layouts.app')
@section('title', 'Importar Densidad por Zona')
@section('content-header')
    @component('components.content-header', ['breadcrumb' => ['Densidad por Zona' => route('data.densidad.index')]])
        @slot('title')
            Importar Densidad por Zona
        @endslot
    @endcomponent
@endsection
@section('css')
...
<div class="box box-primary">
    <form class="form-horizontal" action="{{ route('data.densidad.import')}}" method="POST" enctype="multipart/form-data"> 
        <div class='box-body'>  
            @csrf
