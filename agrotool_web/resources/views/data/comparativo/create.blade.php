@extends('layouts.app')
@section('title', 'Importar Comparativo Variedades')
@section('content-header')
    @component('components.content-header', ['breadcrumb' => ['Comparativo Variedades' => route('data.comparativo.index')]])
        @slot('title')
            Importar Comparativo Variedades
        @endslot
    @endcomponent
@endsection
@section('css')
...
<div class="box box-primary">
    <form class="form-horizontal" action="{{ route('data.comparativo.import')}}" method="POST" enctype="multipart/form-data"> 
        <div class='box-body'>  
            @csrf
