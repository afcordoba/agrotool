...
public class ChangePasswordForm {
	...
	@NotBlank(message="La clave no debe estar en blanco")
	private String currentPassword;

	@NotBlank(message="La nueva clave no debe estar en blanco")
	private String newPassword;

	@NotBlank(message="Confirmar clave no debe estar en blanco")
